...
class Database
    {
    var $Host     = "mysql12.000webhost.com";        // Hostname of our MySQL server.
    var $Database = "a1707631_test";         // Logical database name on that server.
    var $User     = "a1707631_test";             // User and Password for login.
    var $Password = "chapter1";
